...
>
> - When creating a VM resource that requires referring to another resource (disk, NIC, image), you need to pass the full resource ID if that resource is in a different resource group than the targeted one.
