...
| Check the disk space of Network Fabric devices. | You need a minimum of 3 GB of free space within the `/mnt` directory of each network device that's being upgraded. | No | No | The device upgrade command fails for the corresponding device. |
